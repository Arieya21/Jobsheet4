...
public class HargaBayar17 {
    ...
    public static void main(String[] args) {
        ...
        if (jumlah > 1) {
            System.out.println("Terimakasih telah membeli buku " + " sejumlah " + jumlah);
        }
        else {
            System.out.println("Terimakasih telah membeli " + merkBuku);
        }
        System.out.println("Diskon yang anda dapatkan " + jmlDis);
        System.out.println("Jumlah yang harus dibayar adalah" + jmlDis);
